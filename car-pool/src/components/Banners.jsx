    ...
    <div className="">
      ...
      >
        ...
        <div className="w-full lg:w-[70%] text-white font-medium opacity-0.5 text">
          <h1 className="text-2xl lg:text-7xl font-medium mb-2 lg:mb-5 transition-transform duration-300 transform hover:scale-110">{title}</h1>
          <h2 className="text-lg text-wheaty md:text-4xl leading-6 transition-transform duration-300 transform hover:scale-110">{text}</h2>
        </div>
      </div>
    </div>
  );
